...
gulp.task('js', ()=> {
	...
	gulp.src(path.js)
		...
		.pipe(foreach((stream, dir)=> {
			...
			//C:/Users/yoshida-mamoru/Desktop/js_study-master/babel/gulp_babel/src/assets/js/main.js を
			//./src/assets/js/main.js　に変換
			var sourcePath = dirPath.replace( /^.*\/src\//, "./src/" );

			//main.js
			var fileName = dirPath.split("/").pop();
